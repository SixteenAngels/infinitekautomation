...
#define BORDER_WIDTH            LV_DPX_CALC(theme->disp_dpi, 3)     // Infinitek from 2 to 3
...
static void style_init(haspmota_theme_t * theme)
{
    ...
    lv_style_set_radius(&theme->styles.btn,
                        LV_DPX_CALC(theme->disp_dpi, theme->disp_size == DISP_LARGE ? 16 : theme->disp_size == DISP_MEDIUM ? 12 : 10));     // Infinitek min 10
