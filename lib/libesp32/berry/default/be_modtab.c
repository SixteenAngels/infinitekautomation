...
be_extern_native_module(lv_Infinitek);
...
be_extern_native_class(Infinitek_log_reader);
...
BERRY_LOCAL bclass_array be_class_table = {
    ...
    &be_native_class(Infinitek_log_reader),
#ifdef USE_LIGHT
