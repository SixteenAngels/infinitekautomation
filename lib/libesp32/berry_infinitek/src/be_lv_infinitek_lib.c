/********************************************************************
 * Infinitek LVGL lv_signal_bars widget
 *******************************************************************/
...
#include "solidify/solidified_lv_Infinitek.h"

/* @const_object_info_begin
module lv_Infinitek (scope: global, strings: weak) {
    init, closure(module_lv_Infinitek_init_closure)
    _constants, func(lv0_constants_as_hash)

    start, func(lv0_start)
    splash, closure(module_lv_Infinitek_splash_closure)
    splash_init, closure(module_lv_Infinitek_splash_init_closure)
    splash_remove, closure(module_lv_Infinitek_splash_remove_closure)
...
#include "be_fixed_lv_Infinitek.h"
