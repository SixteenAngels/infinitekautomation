...
class Partition_info
  ...
  def get_image_size()
    ...
    try
      ...
      Infinitek.log("BRY: Exception> '" + e + "' - " + m, 2)
      return -1
    end
  end
...
class Partition
  ...
  def resize_fs_to_max()
    ...
    try
      ...
      Infinitek.log(string.format("BRY: Trying to expand FS by %i kB", unallocated), 2)
      ...
      # restart
      Infinitek.global.restart_flag = 2
      Infinitek.log("BRY: Successfully resized FS, restarting", 2)
    except .. as e, m
