...
static const bvalue be_ktab_class_Matter_Plugin_Sensor[37] = {
  ...
  /* K10  */  be_nested_str_weak(Infinitek_sensor_filter),
  /* K11  */  be_nested_str_weak(ARG),
  /* K12  */  be_nested_str_weak(Infinitek_sensor_matcher),
  /* K13  */  be_nested_str_weak(Infinitek),
...
be_local_class(Matter_Plugin_Sensor,
    ...
    ( (struct bmapnode*) &(const bmapnode[]) {
        { be_const_key_weak(Infinitek_sensor_filter, -1), be_const_var(0) },
        ...
        { be_const_key_weak(Infinitek_sensor_matcher, -1), be_const_var(1) },
