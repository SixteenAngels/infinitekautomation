  ...
  def msg_received(raw, addr, port)
    ...
    try
      ...
      if frame.sec_p
        ...
        # -- PROTOCOL_ID_BDX is used for file transfer between devices, not used in Infinitek
        # elif protocol_id == 0x0002  # PROTOCOL_ID_BDX -- BDX not handled at all in Infinitek
