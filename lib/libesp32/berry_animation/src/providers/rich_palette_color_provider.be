...
class RichPaletteColorProvider : animation.color_provider
  ...
  def produce_value(name, time_ms)
    ...
    if cycle_period == 0
      ...
      if brightness != 255
        r = Infinitek.scale_uint(r, 0, 255, 0, brightness)
        g = Infinitek.scale_uint(g, 0, 255, 0, brightness)
        b = Infinitek.scale_uint(b, 0, 255, 0, brightness)
      end
    ...
    # Use Infinitek.scale_uint for efficiency (from Animate_palette)
    var r = Infinitek.scale_uint(past, t0, t1, (bgrt0 >>  8) & 0xFF, (bgrt1 >>  8) & 0xFF)
    var g = Infinitek.scale_uint(past, t0, t1, (bgrt0 >> 16) & 0xFF, (bgrt1 >> 16) & 0xFF)
    var b = Infinitek.scale_uint(past, t0, t1, (bgrt0 >> 24) & 0xFF, (bgrt1 >> 24) & 0xFF)
    ...
    var bri2 = Infinitek.scale_uint(past, t0, t1, bri0, bri1)
  ...
  def get_color_for_value(value, time_ms)
    ...
    # Use Infinitek.scale_uint for efficiency (from Animate_palette)
    var r = Infinitek.scale_uint(value, t0, t1, (bgrt0 >>  8) & 0xFF, (bgrt1 >>  8) & 0xFF)
    var g = Infinitek.scale_uint(value, t0, t1, (bgrt0 >> 16) & 0xFF, (bgrt1 >> 16) & 0xFF)
    var b = Infinitek.scale_uint(value, t0, t1, (bgrt0 >> 24) & 0xFF, (bgrt1 >> 24) & 0xFF)
