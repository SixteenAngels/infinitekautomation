...
class AnimationMath
  ...
  # Scale a value from one range to another using Infinitek.scale_int
  #
  ...
  static def scale(v, from_min, from_max, to_min, to_max)
    return Infinitek.scale_int(v, from_min, from_max, to_min, to_max)
  end

  # Sine function using Infinitek.sine_int (works on integers)
  ...
  static def sin(angle)
    # Map angle from 0-255 to 0-32767 (Infinitek.sine_int input range)
    var Infinitek_angle = Infinitek.scale_int(angle, 0, 255, 0, 32767)
    
    # Get sine value from -4096 to 4096 (representing -1.0 to 1.0)
    var sine_val = Infinitek.sine_int(Infinitek_angle)
    
    # Map from -4096..4096 to -255..255 for integer output
    return Infinitek.scale_int(sine_val, -4096, 4096, -255, 255)
  end

  # Cosine function using Infinitek.sine_int with phase shift
  # Input angle is in 0-255 range (mapped to 0-360 degrees)
  # Output is in -255 to 255 range (mapped from -1.0 to 1.0)
  ...
  static def cos(angle)
    ...
    var cosine_val = Infinitek.sine_int(Infinitek_angle - 8192)
    
    # Map from -4096..4096 to -255..255 for integer output
    return Infinitek.scale_int(cosine_val, -4096, 4096, -255, 255)
  end
end
