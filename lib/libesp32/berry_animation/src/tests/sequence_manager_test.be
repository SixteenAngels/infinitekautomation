...
#    ./berry -s -g -m lib/libesp32/berry_animation -e "import Infinitek" lib/libesp32/berry_animation/tests/sequence_manager_test.be
...
def test_sequence_manager_assignment_steps()
  ...
  Infinitek.set_millis(81002)  # 80502 + 500ms = 81002
...
def test_sequence_manager_integration()
  ...
  Infinitek.set_millis(71005)  # Add 5ms buffer for engine's minimum delta check
