...
# properly integrates with Infinitek's fast_loop system.
#
# Command to run test is:
#    ./berry -s -g -m lib/libesp32/berry_animation -e "import Infinitek" lib/libesp32/berry_animation/tests/fast_loop_integration_test.be
...
def test_on_tick_performance()
  ...
  Infinitek.set_millis(initial_time + 10)
