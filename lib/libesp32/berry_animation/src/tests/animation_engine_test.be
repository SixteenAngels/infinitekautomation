...
var add_time = Infinitek.millis() - start_time
...
start_time = Infinitek.millis()
for i : 0..9
  engine.on_tick(Infinitek.millis())
end
var render_time = Infinitek.millis() - start_time
...
var tick_time = Infinitek.millis()
for i : 0..2
...
for new_length : lengths_to_test
  ...
  dynamic_engine.on_tick(Infinitek.millis())
...
print(f"Success rate: {Infinitek.scale_uint(passed_count, 0, test_count, 0, 100)}%")
