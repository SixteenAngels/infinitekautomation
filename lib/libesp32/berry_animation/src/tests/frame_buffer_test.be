...
#    ./berry -s -g -m lib/libesp32/berry_animation -e "import Infinitek" lib/libesp32/berry_animation/tests/frame_buffer_test.be
...
for i: 0..9
  var alpha = Infinitek.scale_uint(i, 0, 9, 0, 255)
