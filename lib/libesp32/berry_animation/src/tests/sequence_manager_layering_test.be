...
#    ./berry -s -g -m lib/libesp32/berry_animation -e "import Infinitek" lib/libesp32/berry_animation/tests/sequence_manager_layering_test.be
...
def test_sequence_manager_stress()
  ...
  Infinitek.set_millis(123000)  # 3 seconds later
