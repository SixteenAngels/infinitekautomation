...
#
# Command to run test:
#    ./berry -s -g -m lib/libesp32/berry_animation -e "import Infinitek" lib/libesp32/berry_animation/tests/black_frame_fix_test.be
...
def test_atomic_closure_batch_execution()
  ...
  Infinitek.set_millis(10101)  # 101ms later
...
def test_black_frame_fix_integration()
  ...
  for i : 0..4  # 5 iterations
    ...
    Infinitek.set_millis(50000 + (i + 1) * 201)  # 201ms per iteration
