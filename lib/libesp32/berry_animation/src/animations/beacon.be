  ...
  def render(frame, time_ms)
    ...
    if slew_size > 0
      ...
      while i < left_slew_max
        ...
        var blend_factor = Infinitek.scale_int(i, pos - slew_size - 1, pos, 255, 0)
      ...
      while i < right_slew_max
        ...
        var blend_factor = Infinitek.scale_int(i, pos + beacon_size - 1, pos + beacon_size + slew_size, 0, 255)
        var blended_color = frame.blend_linear(back_color, color, blend_factor)
        frame.set_pixel_color(i, blended_color)
        i += 1
      end
