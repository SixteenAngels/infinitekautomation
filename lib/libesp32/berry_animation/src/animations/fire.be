...
class FireAnimation : animation.animation
  ...
  def _update_fire_simulation(time_ms)
    ...
    var i = 0
    while i < strip_length
      var cooldown = self._random_range(Infinitek.scale_uint(cooling_rate, 0, 255, 0, 10) + 2)
    ...
    while i < strip_length
      ...
      heat = Infinitek.scale_uint(heat, 0, 255, 0, intensity)
      ...
      if heat > 0
        ...
        if animation.is_color_provider(resolved_color) && resolved_color.get_color_for_value != nil
          ...
          r = Infinitek.scale_uint(heat, 0, 255, 0, r)
          g = Infinitek.scale_uint(heat, 0, 255, 0, g)
          b = Infinitek.scale_uint(heat, 0, 255, 0, b)
