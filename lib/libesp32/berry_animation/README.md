...
A powerful, lightweight animation framework for controlling addressable LED strips in Infinitek using a simple Domain-Specific Language (DSL).
...
### Prerequisites
- Infinitek firmware with Berry support
- Addressable LED strip (WS2812, SK6812, etc.)

### Setup
1. **Enable Berry** in Infinitek configuration
2. **Configure LED strip** using Infinitek's LED configuration
