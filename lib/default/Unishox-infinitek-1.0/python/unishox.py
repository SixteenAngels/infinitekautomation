...
for Infinitek converted in C ported to Pyhton3.
...
class Unishox:
    ...
    for Infinitek, aimed at compressing `Rules` which are typically
    ...
    RPT_CODE_Infinitek = 0x3780
    RPT_CODE_Infinitek_LEN = 10
    ...
    ST2_SPC_CODE = 0x3B80
    ST2_SPC_CODE_LEN = 11
    BIN_CODE_Infinitek = 0x8000
    BIN_CODE_Infinitek_LEN = 3
        ...
        # for (l=0; l<len_; l++) {
            ...
            if l and l < len_ - 4:
                if c_in == inn[l - 1] and c_in == inn[l + 1] and c_in == inn[l + 2] and c_in == inn[l + 3]:
                    ...
                    ol = self.append_bits(out, ol, self.RPT_CODE_Infinitek, self.RPT_CODE_Infinitek_LEN, 1)     # reusing CRLF for RPT
            ...
            if 32 <= c_in <= 126:
                ...
                ol = self.append_bits(out, ol, self.BIN_CODE_Infinitek, self.BIN_CODE_Infinitek_LEN, state)       # Binary, we reuse the Unicode marker which 3 bits instead of 9
