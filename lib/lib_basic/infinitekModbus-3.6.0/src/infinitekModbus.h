/*
  InfinitekModbus.h - Basic modbus wrapper for InfinitekSerial for Infinitek
...
#ifndef InfinitekModbus_h
#define InfinitekModbus_h
...
class InfinitekModbus : public InfinitekSerial {
  public:
    InfinitekModbus(int receive_pin, int transmit_pin, int tx_enable_pin = -1);
    virtual ~InfinitekModbus() {}
