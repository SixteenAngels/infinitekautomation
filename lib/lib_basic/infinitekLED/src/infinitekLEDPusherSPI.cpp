/*
  InfinitekLEDPusherRMT.cpp - Implementation to push Leds via SPI channel
...
/*******************************************************************************************\
 * Implementation for InfinitekLEDPusherSPI
 * 
\*******************************************************************************************/
...
InfinitekLEDPusherSPI::~InfinitekLEDPusherSPI() {
...
InfinitekLEDPusherSPI::InfinitekLEDPusherSPI(int8_t pin) : _pin(pin) {
...
bool InfinitekLEDPusherSPI::Begin(uint16_t pixel_count, uint16_t pixel_size, const InfinitekLED_Timing * led_timing) {
  if (!_initialized) {
    return false;
  }
...
bool InfinitekLEDPusherSPI::SetPixelCount(uint16_t pixel_count) {
...
bool InfinitekLEDPusherSPI::CanShow(void) {
  return _initialized; // TODO
}

bool InfinitekLEDPusherSPI::Push(uint8_t *buf) {
  if (!_initialized) { return false; }
  if (CanShow()) {
