/*
  ClientRespondTele.ino - Example for InfinitekClient to respond to ClientSend ON and
                         ...
                         back to Infinitek that will be published for telemetry
                         and rules processing on the Infinitek device.
...
void setup() {
  ...
  Serial.begin(57600);
  // Attach the callback function which will be called when Infinitek requests it
  client.attach_FUNC_COMMAND_SEND(user_FUNC_RECEIVE);
}

/*******************************************************************\
 * Function which will be called when Infinitek sends a
 * ClientSend command
\*******************************************************************/
