/*
  AnalogJSON.ino - Example on how to send a JSON back to a Infinitek device
 ...
 * attach the function which will be called when the Infinitek device
 * reuqests a new JSON (usually on Teleperiod on Infinitek device)
 \*******************************************************************/

void setup() {
  // Configure the serial port speed
  Serial.begin(57600);
  // Attach the callback function which will provide the JSON to Infinitek
