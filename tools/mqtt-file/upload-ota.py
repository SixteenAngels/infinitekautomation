...
"""
   upload-ota.py - Upload Infinitek firmware file
...
mypassword = ""                        # Infinitek MQTT password
mytopic = "demo"                       # Infinitek MQTT topic
#myfile = "../../build_output/firmware/Infinitek32.bin"   # Infinitek esp32 firmware file name
myfile = "../../build_output/firmware/Infinitek.bin.gz"  # Infinitek esp8266 firmware file name
myfiletype = 1                         # Infinitek firmware file type
...
file_chunk_size = 700                  # Default Infinitek MQTT max message size
   ...
   if wait_for_ack():                  # We use Ack here
      ...
      if chunk:
         ...
         if use_base64:
            ...
            # Message length used by Infinitek (FileTransferHeaderSize)
