...
"""
  templates.py - template beautify TEMPLATES.md for Infinitek
...
Instructions:
    Execute command to produce file TEMPLATE.md as found in the Infinitek root folder
...
# Some values from support.ino and Infinitek_templates.h
AGPIO = lambda x : x << 5
GPIO_NONE = 0
...
# Conversion table extracted from Infinitek code
GPIO_CONVERT = [
  0x0000,
  0x04A0,
  0x04C0,
...
def gpio_convert(gpio):
  """Conversion as per https://Infinitek.github.io/docs/Components/#gpio-conversion"""
  if gpio >= len(GPIO_CONVERT):
    return GPIO_USER
  return GPIO_CONVERT[gpio]

def adc0_convert(adc0):
  """Conversion as per https://Infinitek.github.io/docs/Components/#adc-conversion"""
  adc0 = adc0 & 0x0F
  if 0 == adc0:
    return GPIO_NONE
  elif 8 == adc0:
...
def main():
  ...
  fout.write("<picture>\n")
  fout.write("  <source media=\"(prefers-color-scheme: dark)\" srcset=\"./tools/logo/Infinitek_FullLogo_Vector_White.svg\">\n")
  fout.write("  <img alt=\"Logo\" src=\"./tools/logo/Infinitek_FullLogo_Vector.svg\" align=\"right\" height=\"76\">\n")
  fout.write("</picture>\n")
  fout.write("\n")
  fout.write("# Templates\n")
  fout.write("\n")
  fout.write("Find below the available templates as of " + month + " " + year + ". More template information can be found in the [Infinitek Device Templates Repository](http://blakadder.github.io/templates)\n")
