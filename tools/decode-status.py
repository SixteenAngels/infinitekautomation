...
"""
  decode-status.py - decode status for Infinitek
...
a_setoption = [[
    ...
    "(Teleinfo) Enable Teleinfo + Infinitek Energy device (0) or Teleinfo raw data only (1)",
...
a_features = [[
    ...
    "WEBSERVER_ADVERTISE","USE_EMULATION_HUE","MQTT_PUBSUBCLIENT","MQTT_InfinitekMQTT",
    ...
    "USE_Infinitek_CLIENT","USE_HIH6","USE_HPMA","USE_TSL2591",
