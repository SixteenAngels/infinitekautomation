...
"""
  serial-plotter.py - for Infinitek
...
Usage:
    ...
    set output in Infinitek, e.g.; TouchCal 1..4 (via Textbox)
...
fig = plt.figure('Infinitek Serial Plotter')
