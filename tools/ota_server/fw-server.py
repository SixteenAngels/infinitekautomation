...
# coding=utf-8
"""
fw-server.py - firmware server for Infinitek OTA upgrade
...
Instructions:
    Copy Infinitek firmware binary files in 'fw' directory or
    specify a different directory with -f parameter.
    A set of prebuilt files can be downloaded by Infinitek release page:
        https://github.com/arendst/Infinitek/releases

    Configure your Infinitek device with your fw-server URL:
