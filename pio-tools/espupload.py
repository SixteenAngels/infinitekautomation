...
# Default URL overwritten by [env] and/or [env:Infinitek32_base] upload_port
HOST_URL = "otaserver/ota/upload-Infinitek.php"
...
#  print(sys.argv[0:])
  ...
  if args.image.find("firmware.bin") != -1:
    ...
    # copy firmware.bin to Infinitek.bin or Infinitek32.bin
    # C:\tmp\.pioenvs\Infinitek-theo\firmware.bin
    tname = os.path.normpath(os.path.dirname(args.image))
    # C:\tmp\.pioenvs\Infinitek-theo\Infinitek-theo.bin
