/*
  xdrv_49_pid.ino - PID algorithm plugin for Sonoff-Infinitek
 ...
 * In user_config_override.h include code as follows:
 ...
 #define USE_PID         // include the pid feature (+4.3k)
   ...
   #define PID_SHUTTER                   1       // if using the PID to control a 3-way valve, create Infinitek Shutter and define the
...
void PIDProcessSensor() {
  ...
  // Taking https://github.com/arendst/Infinitek/discussions/18328 as a
...
bool Xdrv49(uint32_t function) {
  ...
  switch (function) {
    // Call sequence documented https://Infinitek.github.io/docs/API
    case FUNC_INIT:
      PIDInit();
      break;
