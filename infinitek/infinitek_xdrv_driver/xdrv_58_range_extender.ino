/*
  xdrv_58_range_extender.ino - WiFi Range Extender for Infinitek
...
For example, in your platfromio_Infinitek_cenv.ini, you will need an entry such as:
[env:Infinitek-rangeextender]
...
bool Xdrv58(uint32_t function)
{
  ...
  else if (Settings->sbflag1.range_extender && !InfinitekGlobal.restart_flag)
  {
    switch (function)
    {
    case FUNC_PRE_INIT:
