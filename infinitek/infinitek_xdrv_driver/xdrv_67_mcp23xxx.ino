/*
  xdrv_67_mcp23xxx.ino - MCP23008/MCP23017/MCP23S17 GPIO Expander support for Infinitek
 ...
 *
 * The goal of the driver is to provide a sequential list of pins configured as Infinitek template
...
#ifdef USE_SPI
  if ((SPI_MOSI_MISO == InfinitekGlobal.spi_enabled) && PinUsed(GPIO_MCP23SXX_CS, GPIO_ANY)) {
#ifdef ESP8266
    SPI.begin();
#endif
#ifdef ESP32
...
//            MCP23xWrite(MCP23X17_IOCONA, 0b01011000);  // Enable INT mirror, Slew rate disabled, HAEN pins for addressing
  ...
  Mcp23x.relay_offset = InfinitekGlobal.devices_present;
...
#ifdef USE_SPI
  spi_enabled = (SPI_MOSI_MISO == InfinitekGlobal.spi_enabled);
#endif  // USE_SPI
#ifdef USE_I2C
