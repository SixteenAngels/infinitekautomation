/*
  xdrv_73_0_lora_struct.ino - LoRa support for Infinitek
...
#define TAS_LORAWAN_JOINNONCE               0x00E50631    // Infinitek node 1 JoinNonce
#define TAS_LORAWAN_NETID                   0x00000000    // Infinitek private network
