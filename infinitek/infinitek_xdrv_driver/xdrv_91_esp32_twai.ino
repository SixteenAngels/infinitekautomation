/*
  xdrv_91_esp32_twai.ino - ESP32 TWAI support for Infinitek
 ...
 * 
 * For more information see https://Infinitek.github.io/docs/TWAI/
 * 
 * Supported command:
...
class twai_cls
  ...
  def init()
    ...
    Infinitek.add_driver(global.twai_driver := self)
  end
