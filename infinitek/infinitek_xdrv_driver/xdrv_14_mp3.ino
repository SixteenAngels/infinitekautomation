/*
  xdrv_14_mp3.ino - MP3 support for Infinitek
  ...
  ---
  0.9.0.1 20180905  added   - #include <InfinitekSerial.h> because compiler error (Arduino IDE v1.8.5)
  ---
  0.9.0.0 20180901  started - further development by mike2nl  - https://github.com/mike2nl/Sonoff-Infinitek
                    base    - code base from gemu2015 ;-)     - https://github.com/gemu2015/Sonoff-Infinitek
                    forked  - from arendst/Infinitek            - https://github.com/arendst/Infinitek


                  Ver 12.1.0.4x
                  /include/Infinitek/Infinitek_template.h
                  @ line 56
...
{
  MP3Player = new InfinitekSerial(-1, Pin(GPIO_MP3_DFR562));
