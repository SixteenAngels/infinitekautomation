/*
  xdrv_84_esp32_hosted.ino - ESP32 Hosted MCU support for Infinitek
...
void CmndHostedOta(void) {
  /*
  If OtaUrl = "https://ota.Infinitek.com/Infinitek32/Infinitek32p4.bin"
   Then use "https://ota.Infinitek.com/Infinitek32/coprocessor/network_adapter_" CONFIG_ESP_HOSTED_IDF_SLAVE_TARGET ".bin"
  As an option allow user to enter URL like:
   HostedOta https://ota.Infinitek.com/Infinitek32/coprocessor/network_adapter_esp32c6.bin
   HostedOta https://ota.Infinitek.com/Infinitek32/coprocessor/v2.0.14/network_adapter_esp32c6.bin
  ...
  */
  ...
  if (XdrvMailbox.data_len > 15) {
    ...
    // Replace https://ota.Infinitek.com/Infinitek32/Infinitek32p4.bin  with https://ota.Infinitek.com/Infinitek32/coprocessor/network_adapter_esp32c6.bin
    char ota_url[TOPSZ];
    ...
    *bch = '\0';                                                 // full_ota_url = https://ota.Infinitek.com/Infinitek32
    char version[16] = { 0 };
