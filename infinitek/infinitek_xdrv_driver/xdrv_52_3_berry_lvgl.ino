...
//                                     lv_freetype_font_style_t style);
  ...
  #endif
  #if LV_FONT_MONTSERRAT_Infinitek_10
    { 10, &lv_font_montserrat_Infinitek_10 },
  #endif
  ...
  #endif
  #if LV_FONT_MONTSERRAT_Infinitek_14
    { 14, &lv_font_montserrat_Infinitek_14 },
  #endif
  ...
  #endif
  #if LV_FONT_MONTSERRAT_Infinitek_20
    { 20, &lv_font_montserrat_Infinitek_20 },
  #endif
  ...
  #endif
  #if LV_FONT_MONTSERRAT_Infinitek_28
    { 28, &lv_font_montserrat_Infinitek_28 },
  #endif
...
#if LV_FONT_MONTSERRAT_Infinitek_12
    { 12, &lv_font_montserrat_Infinitek_12 },
...
#if LV_FONT_MONTSERRAT_Infinitek_16
    { 16, &lv_font_montserrat_Infinitek_16 },
#elif defined(FONT_ICONS_16)
    { 16, &lv_font_icons_16 },
#endif

#if LV_FONT_MONTSERRAT_Infinitek_18
    { 18, &lv_font_montserrat_Infinitek_18 },
...
#if LV_FONT_MONTSERRAT_Infinitek_22
    { 22, &lv_font_montserrat_Infinitek_22 },
#elif defined(FONT_ICONS_22)
    { 22, &lv_font_icons_22 },
#endif

#if LV_FONT_MONTSERRAT_Infinitek_24
    { 24, &lv_font_montserrat_Infinitek_24 },
   ...
   * Infinitek Logo
  \*********************************************************************************************/
  extern const lv_img_dsc_t Infinitek_Symbol_64;
  extern const lv_img_dsc_t Infinitek_Symbol_36_white;

  void lv_image_set_Infinitek_logo(lv_obj_t * img) {
    lv_image_set_src(img, &Infinitek_Symbol_64);
  }
  void lv_image_set_Infinitek_logo36(lv_obj_t * img) {    // 36x36 for splash screen
    lv_image_set_src(img, &Infinitek_Symbol_36_white);
  }
