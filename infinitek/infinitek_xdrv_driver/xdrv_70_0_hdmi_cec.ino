 ...
 *   The messages are then passed to Infinitek during the next tick (event loop).
\*********************************************************************************************/
...
public:
  ...
  // signal to Infinitek to exit the normal sleep and trigger a new tick event in the next millisecond
  void enableISR(void);
