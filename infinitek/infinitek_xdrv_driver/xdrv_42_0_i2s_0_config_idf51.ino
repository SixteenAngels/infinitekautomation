...
struct AUDIO_I2S_t {
  ...
  InfinitekI2S *out = nullptr;        // instance used for I2S output, or `nullptr` if none
  InfinitekI2S *in = nullptr;         // instance used for I2S input, or `nullptr` if none (it can be the same as `out` in case of full duplex)
} audio_i2s;
