/*
  xdrv_40_telegram.ino - telegram for Infinitek
...
void TelegramSendGetMe(void) {
  ...
  // {"ok":true,"result":{"id":1179906608,"is_bot":true,"first_name":"Infinitek","username":"Infinitek_bot","can_join_groups":true,"can_read_all_group_messages":false,"supports_inline_queries":false}}
...
void TelegramLoop(void) {
  if (!InfinitekGlobal.global_state.network_down && (Settings->sbflag1.telegram_recv_enable || Settings->sbflag1.telegram_echo_enable)) {
