/*
  xdrv_52_3_berry_Infinitek.ino - Berry scripting language, native fucnctions
 ...
 * import Infinitek
 *
 * Infinitek.get_free_heap() -> int
 * Infinitek.publish(topic:string, payload:string[, retain:bool]) -> nil
 * Infinitek.cmd(command:string) -> string
 * Infinitek.get_option(index:int) -> int
 * Infinitek.millis([delay:int]) -> int
 * Infinitek.time_reached(timer:int) -> bool
 * Infinitek.yield() -> nil
 *
 * Infinitek.get_light([index:int = 0]) -> map
 * Infinitek.get_power([index:int = 0]) -> bool
 * Infinitek.set_power(idx:int, power:bool) -> bool or nil
 * Infinitek.set_light(idx:int, values:map) -> map
 *
\*********************************************************************************************/
extern "C" {
  // Berry: `Infinitek.publish_result(payload:string, subtopic:string) -> nil``
  //
  ...
  // Berry: `Infinitek.publish_rulet(payload:string) -> bool``
  //
  ...
  // Berry: `Infinitek.cmd(command:string) -> string`
  //
  ...
  // Berry: Infinitek.millis([delay:int]) -> int
  //
  ...
  // Berry: Infinitek.get_option(index:int) -> int
  //
  ...
  // Berry: Infinitek.time_reached(timer:int) -> bool
  //
  ...
  // Berry: Infinitek.hostname() -> string
  //
  ...
  // Berry: Infinitek.delay(timer:int) -> nil
  //
  ...
  // Berry: Infinitek.delay_microseconds(timer:int) -> nil
  //
  ...
  // Berry: Infinitek.scale_uint(int * 5) -> int
  //
  ...
  // Berry: Infinitek.scale_int(int * 5) -> int
  //
  ...
  */
  ...
  // Berry: Infinitek.sine_int(int) -> int
  //
  // Input: 8192 is pi/2
  ...
  int32_t be_Infinitek_version(void) {
  ...
  assert(Infinitek._find_op("aaa#bbc==23") == 0x80007)
  assert(Infinitek._find_op("az==23") == 0x30002)
  assert(Infinitek._find_op("a>23") == 0x10001)
  assert(Infinitek._find_op("aaa#bbc!23") == -1)
  ...
  */
  ...
  //
  // `Infinitek._apply_str_op(op, a, b)`
  // Args:
  // op: operator (int)
  ...
  # unit tests
  # equals
  assert(Infinitek._apply_str_op(1, "aa", "AA") == true)
  assert(Infinitek._apply_str_op(1, "aa", "AAA") == false)
  assert(Infinitek._apply_str_op(1, "a", "AA") == false)
  assert(Infinitek._apply_str_op(1, "", "AA") == false)
  assert(Infinitek._apply_str_op(1, "aa", "") == false)
  assert(Infinitek._apply_str_op(1, "", "") == true)

  # not equals
  assert(Infinitek._apply_str_op(2, "aa", "AA") == false)
  assert(Infinitek._apply_str_op(2, "aa", "AAA") == true)
  assert(Infinitek._apply_str_op(2, "a", "AA") == true)
  assert(Infinitek._apply_str_op(2, "", "AA") == true)
  assert(Infinitek._apply_str_op(2, "aa", "") == true)
  assert(Infinitek._apply_str_op(2, "", "") == false)

  # starts with
  assert(Infinitek._apply_str_op(3, "aabbcc", "AA") == true)
  assert(Infinitek._apply_str_op(3, "aaabbcc", "AA") == true)
  assert(Infinitek._apply_str_op(3, "abbaacc", "AA") == false)
  assert(Infinitek._apply_str_op(3, "aabbcc", "a") == true)
  assert(Infinitek._apply_str_op(3, "aabbcc", "") == true)
  assert(Infinitek._apply_str_op(3, "", "") == true)
  assert(Infinitek._apply_str_op(3, "", "a") == false)

  assert(Infinitek._apply_str_op(3, "azeaze", "az") == true)
  assert(Infinitek._apply_str_op(3, "azeaze", "ze") == false)

  # ends with
  assert(Infinitek._apply_str_op(4, "azeaze", "az") == false)
  assert(Infinitek._apply_str_op(4, "azeaze", "ze") == true)
  assert(Infinitek._apply_str_op(4, "azeaze", "") == true)
  assert(Infinitek._apply_str_op(4, "", "aa") == false)
  assert(Infinitek._apply_str_op(4, "aa", "aa") == true)
  assert(Infinitek._apply_str_op(4, "aabaa", "aa") == true)

  # contains
  assert(Infinitek._apply_str_op(5, "azeaze", "az") == true)
  assert(Infinitek._apply_str_op(5, "azeaze", "ze") == true)
  assert(Infinitek._apply_str_op(5, "azeaze", "") == true)
  assert(Infinitek._apply_str_op(5, "azeaze", "e") == true)
  assert(Infinitek._apply_str_op(5, "azeaze", "a") == true)
  assert(Infinitek._apply_str_op(5, "azeaze", "z") == true)
  assert(Infinitek._apply_str_op(5, "azertyuiop", "tyui") == true)
  assert(Infinitek._apply_str_op(5, "azertyuiop", "azr") == false)
  assert(Infinitek._apply_str_op(5, "", "aze") == false)

  # not contains
  assert(Infinitek._apply_str_op(6, "azeaze", "az") == false)
  assert(Infinitek._apply_str_op(6, "azeaze", "ze") == false)
  assert(Infinitek._apply_str_op(6, "azeaze", "") == false)
  assert(Infinitek._apply_str_op(6, "azeaze", "e") == false)
  assert(Infinitek._apply_str_op(6, "azeaze", "a") == false)
  assert(Infinitek._apply_str_op(6, "azeaze", "z") == false)
  assert(Infinitek._apply_str_op(6, "azertyuiop", "tyui") == false)
  assert(Infinitek._apply_str_op(6, "azertyuiop", "azr") == true)
  assert(Infinitek._apply_str_op(6, "", "aze") == true)
  ...
  */
  ...
  int32_t l_getpower(bvm *vm) {
    power_t pow = InfinitekGlobal.power;
    int32_t top = be_top(vm); // Get the number of arguments
    if (top >= 2 && be_isint(vm, 2)) {
      int32_t idx = be_toint(vm, 2);
      if (idx >= 0 && idx < InfinitekGlobal.devices_present) {
...
extern "C" {
  ...
  void Infinitek_log_C(int32_t loglevel, const char * berry_buf, ...) {
    va_list arg;
    va_start(arg, berry_buf);
