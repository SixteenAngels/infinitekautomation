/*
  xdrv_73_8_lorawan_bridge.ino - LoRaWan EU868/AU915 support for Infinitek
 ...
 *  - Infinitek needs a filesystem to store persistent data (#define USE_UFILESYS)
 *  - Infinitek Lora has to be configured for one of the three EU868 supported frequencies and
 ...
 *  - Infinitek Lora has to be configured for AU915 using command
  ...
  switch (Lora->settings.region) {
    case TAS_LORA_REGION_AU915: {
      ...
      Downlink
        ...
        Infinitek does not support different RX1 & RX2 DRs (yet), so just use DR8 and rely on RX2 arriving at end device OK.
      */
