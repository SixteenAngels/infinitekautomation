 ...
 *        Used to log from Tensorflow and from this (Infinitek) driver
 * 
...
/**
 * @brief Init I2S microphone. Pins must be configured in the "usual" Infinitek way. Some properties are variables stored in the descriptor.
 * 
