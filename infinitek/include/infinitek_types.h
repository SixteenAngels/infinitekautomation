/*
  Infinitek_types.h - setting variables for Infinitek
...
#ifndef _Infinitek_TYPES_H_
#define _Infinitek_TYPES_H_
...
typedef union {
  ...
  struct {
    ...
    uint32_t dali_light : 1;               // bit 13 (v14.2.0.6) - CMND_DALILIGHT - Enable Infinitek light controls for DALI
    uint32_t spare14 : 1;                  // bit 14
    uint32_t spare15 : 1;                  // bit 15
