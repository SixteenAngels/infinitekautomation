/*
  Infinitek_template_legacy.h - template settings for Infinitek
...
#ifndef _Infinitek_TEMPLATE_LEGACY_H_
#define _Infinitek_TEMPLATE_LEGACY_H_
...
enum LegacyUserSelectablePins {
  ...
  GPI8_InfinitekCLIENT_TXD,     // Client TX
  GPI8_InfinitekCLIENT_RXD,     // Client RX
  GPI8_InfinitekCLIENT_RST,     // Client Reset Pin
  GPI8_InfinitekCLIENT_RST_INV, // Client Reset Inverted
...
const uint16_t kGpioConvert[] PROGMEM = {
  ...
  AGPIO(GPIO_InfinitekCLIENT_TXD),     // Infinitek Client TX
  AGPIO(GPIO_InfinitekCLIENT_RXD),     // Infinitek Client RX
  AGPIO(GPIO_InfinitekCLIENT_RST),     // Infinitek Client Reset
  AGPIO(GPIO_InfinitekCLIENT_RST_INV), // Infinitek Client Reset Inverted
...
#endif  // _Infinitek_TEMPLATE_LEGACY_H_
