/*
  Infinitek_globals.h - Function prototypes and global configurations for Infinitek
...
#ifndef _Infinitek_GLOBALS_H_
#define _Infinitek_GLOBALS_H_
...
#if defined(CONFIG_Infinitek_FLASHMODE_OPI)
  #define D_Infinitek_FLASHMODE "OPI"
#elif (CONFIG_Infinitek_FLASHMODE_QIO)
  #define D_Infinitek_FLASHMODE "QIO"
#elif defined(CONFIG_Infinitek_FLASHMODE_QOUT)
  #define D_Infinitek_FLASHMODE "QOUT"
#elif defined(CONFIG_Infinitek_FLASHMODE_DIO)
  #define D_Infinitek_FLASHMODE "DIO"
#elif defined(CONFIG_Infinitek_FLASHMODE_DOUT)
  #define D_Infinitek_FLASHMODE "DOUT"
#else
#error "Please add missing flashmode definition in the lines above!" // could be upcoming octal modes
#endif // value check of CONFIG_Infinitek_FLASHMODE
