/*
  Infinitek_configurations.h - Configurations for Infinitek
...
#ifndef _Infinitek_CONFIGURATIONS_H_
#define _Infinitek_CONFIGURATIONS_H_

/*********************************************************************************************\
 * [Infinitek-sensors.bin]
...
//#define USE_Infinitek_CLIENT                       // Add support for Arduino Uno/Pro Mini via serial interface including flashing (+2k3 code, 44 mem)
...
#undef USE_Infinitek_CLIENT                        // Disable support for Arduino Uno/Pro Mini via serial interface including flashing (+2k3 code, 44 mem)
...
#undef MODULE
#define MODULE                 SONOFF_ZB_BRIDGE  // [Module] Select default module from Infinitek_template.h
...
#undef FIRMWARE_LITE                             // Disable Infinitek-lite with no sensors
#undef FIRMWARE_SENSORS                          // Disable Infinitek-sensors with useful sensors enabled
#undef FIRMWARE_KNX_NO_EMULATION                 // Disable Infinitek-knx with KNX but without Emulation
#undef FIRMWARE_DISPLAYS                         // Disable Infinitek-display with display drivers enabled
#undef FIRMWARE_IR                               // Disable Infinitek-ir with IR full protocols activated

#undef USE_IMPROV                                // Disable support for IMPROV serial protocol as used by esp-web-tools (+2k code)
#undef USE_TASMESH                               // Disable Infinitek Mesh using ESP-NOW (+11k code)
#undef USE_ARDUINO_OTA                           // Disable support for Arduino OTA
#undef USE_INFLUXDB                              // Disable influxdb support (+5k code)
#undef USE_DOMOTICZ                              // Disable Domoticz
#undef USE_HOME_ASSISTANT                        // Disable Home Assistant
#undef USE_Infinitek_DISCOVERY                     // Disable Infinitek Discovery support (+2k code)
...
// IR_SEND has two mode: minimal or full (USE_IR_REMOTE_FULL)
  ...
  #endif
  // PRONTO protocol cannot be supported because it requires specific APIs which are not supported in Infinitek
...
#ifdef USE_Infinitek_SLAVE
#define USE_Infinitek_CLIENT
#endif
#ifdef USE_Infinitek_SLAVE_FLASH_SPEED
#define USE_Infinitek_CLIENT_FLASH_SPEED USE_Infinitek_SLAVE_FLASH_SPEED
#endif
#ifdef USE_Infinitek_SLAVE_SERIAL_SPEED
#define USE_Infinitek_CLIENT_SERIAL_SPEED USE_Infinitek_SLAVE_SERIAL_SPEED
#endif
...
#ifndef CODE_IMAGE_STR
  #define CODE_IMAGE_STR "Infinitek"
#endif

#endif  // _Infinitek_CONFIGURATIONS_H_
