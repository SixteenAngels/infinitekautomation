/*
  xdsp_05_epaper.ino - Display e-paper support for Infinitek
...
void EpdInitDriver42() {
  if (PinUsed(GPIO_EPAPER42_CS) &&
     ((InfinitekGlobal.soft_spi_enabled & SPI_MOSI) || (InfinitekGlobal.spi_enabled & SPI_MOSI))) {
    ...
    else if (InfinitekGlobal.spi_enabled) {
