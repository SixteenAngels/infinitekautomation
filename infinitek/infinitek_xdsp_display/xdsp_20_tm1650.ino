/*
  xdsp_20_tm1650.ino - TM1650 four-digit seven-segment LED display controller support for Infinitek
...
/*********************************************************************************************\
  ...
  To use, compile Infinitek with USE_I2C, USE_DISPLAY and USE_DISPLAY_TM1650, or build the Infinitek-display env.

  For TM1650:
  Connect the TM1650 display module's pins to any free GPIOs of the ESP8266 module
  and assign the pins as follows from Infinitek's GUI:
