/*
  xdsp_13_tm1640.ino - TM1640B LED display controller support for Infinitek
...
/*********************************************************************************************\
  ...
  To use, compile Infinitek with USE_DISPLAY, USE_DISPLAY_TM1640 and USE_IOTTIMER, or build the Infinitek-display
  firmware.
  ...
  For the IoTTimer clock assign the pins as follows from Infinitek's GUI:
...
/*
  ...
  home automation using Infinitek and rules.
...
void IoTTimerUpdateTemperature(void) {
  IoTTimerShowFloat(ConvertTempToFahrenheit(InfinitekGlobal.temperature_celsius));
}
  ...
  if (Settings->display_mode) {  // Mode 0 is User text
    switch (Settings->display_mode) {
      ...
      case 2:  // Date
        ...
        break;
      case 3: // Time/Date
        if (InfinitekGlobal.uptime % Settings->display_refresh)
        {
          IoTTimerShowTime();
        }
        else
