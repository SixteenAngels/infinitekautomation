/*
  xlgt_10_bp1658cj.ino - bp1658cj five channel led support for Infinitek
...
void BP1658CJModuleSelected(void)
{
  if (PinUsed(GPIO_BP1658CJ_CLK) && PinUsed(GPIO_BP1658CJ_DAT, GPIO_ANY)) {
    ...
    // See #define MAX_BP1658CJ_DAT 16 in Infinitek_template.h
    ...
    InfinitekGlobal.light_driver = XLGT_10;
