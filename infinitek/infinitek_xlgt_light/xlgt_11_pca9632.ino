/*
  xlgt_11_pca9632.ino - pca9632 four channel led support for Infinitek
...
bool PCA9632_ModuleSelected(void) {
  ...
  if (PCA9632_Detect()) {
    ...
    InfinitekGlobal.light_type += LST_RGBW;    // Add RGBW to be controlled by PCA9632
    InfinitekGlobal.light_driver = XLGT_11;
