/*
  xsns_103_sen5x.ino - SEN5X gas and air quality sensor support for Infinitek
 ...
 *
 * Source: Sensirion SEN5X Driver + Example, and Infinitek Driver 98 by Jean-Pierre Deschamps
 * Adaption for Infinitek: Tyeth Gundry
 *
 * I2C Address: 0x69
\*********************************************************************************************/
...
bool Xsns103(uint32_t function) {
  ...
  if (FUNC_INIT == function) {
    ...
    case FUNC_EVERY_SECOND:
      if (Settings->flag6.sen5x_passive_mode) {
        if (InfinitekGlobal.uptime % SEN5X_PASSIVE_MODE_INTERVAL == 0) {
          SEN5XUpdate();
        }
      }
      else {
