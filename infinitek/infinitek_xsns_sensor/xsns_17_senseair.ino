/*
  xsns_17_senseair.ino - SenseAir CO2 sensor support for Infinitek
...
InfinitekModbus *SenseairModbus;
...
void SenseairInit(void)
{
  ...
  if (PinUsed(GPIO_SAIR_RX) && PinUsed(GPIO_SAIR_TX)) {
    SenseairModbus = new InfinitekModbus(Pin(GPIO_SAIR_RX), Pin(GPIO_SAIR_TX));
