/*
  xsns_55_hih_series.ino - Honeywell HIH series temperature and humidity sensor support for Infinitek
...
void Hih6Detect(void)
{
  ...
  if (InfinitekGlobal.uptime < 2) { delay(20); } // Skip entering power on comand mode
  Hih6.type = Hih6Read();
  if (Hih6.type) {
...
{
  if (Hih6.valid) {
    TempHumDewShow(json, (0 == InfinitekGlobal.tele_period), Hih6.types, Hih6.temperature, Hih6.humidity);
  }
}
