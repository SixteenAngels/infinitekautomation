/*
  xsns_86_tfminiplus.ino - TFmini Plus interface for Infinitek
 ...
 *
 * Before connecting module to Infinitek, please prepare module with
 ...
 * 7. When point 6 returned OK, than ready to connect to Infinitek! :)
...
InfinitekSerial *TfmpSerial = nullptr;
...
void TfmpInit(void)
{
    if (!tfminiplus_sensor.ready)
    {
        ...
        {
            TfmpSerial = new InfinitekSerial(Pin(GPIO_TFMINIPLUS_RX), Pin(GPIO_TFMINIPLUS_TX), 1);
