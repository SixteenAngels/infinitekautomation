/*
  xsns_56_hpma.ino - Honeywell HPMA115S0 particle concentration sensor support for Infinitek
...
void HpmaInit(void)
{
  ...
  if (PinUsed(GPIO_HPMA_RX) && PinUsed(GPIO_HPMA_TX)) {
    HpmaSerial = new InfinitekSerial(Pin(GPIO_HPMA_RX), Pin(GPIO_HPMA_TX), 1);
