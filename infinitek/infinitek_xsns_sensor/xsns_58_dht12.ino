/*
  xsns_58_dht12.ino - DHT12 I2C temperature and humidity sensor support for Infinitek
...
{
  if (Dht12.valid) {
    TempHumDewShow(json, (0 == InfinitekGlobal.tele_period), Dht12.name, Dht12.temperature, Dht12.humidity);
  }
}
