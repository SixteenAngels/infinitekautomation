/*
  xsns_99_ens210.ino - ENS210 gas and air quality sensor support for Infinitek
...
{
  if (ENS210data->ready) {
    TempHumDewShow(json, (0 == InfinitekGlobal.tele_period), ENS210_DEVICE_NAME, ENS210data->temperature, ENS210data->humidity);
  }
}
