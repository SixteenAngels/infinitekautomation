/*
  xsns_102_ld2402.ino - HLK-LD2402 24GHz smart wave motion sensor support for Infinitek
...
InfinitekSerial *LD2402Serial = nullptr;
...
void Ld2402Detect(void) {
  if (PinUsed(GPIO_LD2402_RX) && PinUsed(GPIO_LD2402_TX)) {
    ...
    LD2402Serial = new InfinitekSerial(Pin(GPIO_LD2402_RX), Pin(GPIO_LD2402_TX), 2, 0, LD2402_BUFFER_SIZE);
