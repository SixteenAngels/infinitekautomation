/*
  xsns_08_htu21.ino - HTU21 temperature and humidity sensor support for Infinitek
...
void HtuEverySecond(void) {
  if (InfinitekGlobal.uptime &1) {  // Every 2 seconds
...
void HtuShow(bool json) {
  if (Htu.valid) {
    TempHumDewShow(json, (0 == InfinitekGlobal.tele_period), Htu.types, Htu.temperature, Htu.humidity);
  }
}
