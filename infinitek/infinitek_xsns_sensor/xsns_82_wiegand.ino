/*
  xsns_82_wiegand.ino - Support for Wiegand Interface 125kHz Rfid Tag Reader for Infinitek
 ...
 *  - fix 64-bit representation after removal of %llu support (Infinitek does not support 64-bit decimal output specifier (%llu) saving 60k code)
