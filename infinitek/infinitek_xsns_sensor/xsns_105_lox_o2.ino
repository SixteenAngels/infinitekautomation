/*
  xsns_105_lox_o2.ino - Support for LuminOx Sealed Optical Oxygen Sensor on Infinitek
...
InfinitekSerial *LOXSerial = nullptr;
...
void LOXInit()
{
  if (PinUsed(GPIO_LOX_O2_RX))
  {
    ...
    LOXSerial = new InfinitekSerial(Pin(GPIO_LOX_O2_RX), -1, 1);
