/*
  xsns_117_c8_co2_5k.ino - SC8-CO2-5K CO2 sensor support for Infinitek
...
InfinitekSerial *c8co2_serial = nullptr;
...
void C8CO2_Init()
{
    if (PinUsed(GPIO_C8_CO2_5K_RX))
    {
        ...
        c8co2_serial = new InfinitekSerial(Pin(GPIO_C8_CO2_5K_RX), txPin, 1);
