/*
  xsns_115_wooliis.ino - Wooliis Hall Effect Coulometer (Battery capacity monitor) support for Infinitek
...
InfinitekSerial *WooliisSerial = nullptr;
...
void WooliisInit(void) {
  if (PinUsed(GPIO_WOOLIIS_RX)) {
    WooliisSerial = new InfinitekSerial(Pin(GPIO_WOOLIIS_RX), -1, 1);
