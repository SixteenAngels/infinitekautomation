/*
  xsns_107_gm861.ino - Support for GM861 Bar Code Reader for Infinitek
 ...
 *
 * For background information see https://github.com/arendst/Infinitek/discussions/18399
 *
 * Commands available:
...
InfinitekSerial *Gm861Serial = nullptr;
...
void Gm861Init(void) {
  if (PinUsed(GPIO_GM861_RX) && PinUsed(GPIO_GM861_TX)) {
    ...
    Gm861Serial = new InfinitekSerial(Pin(GPIO_GM861_RX), Pin(GPIO_GM861_TX), 1);
...
void Gm861Heartbeat(void) {
  if (!Gm861->state && (!(InfinitekGlobal.uptime % 10))) {
