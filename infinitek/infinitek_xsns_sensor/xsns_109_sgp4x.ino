/*
  xsns_109_sgp4x.ino - SGP4X VOC and NOx sensor support for Infinitek
 ...
 * Adaption for Infinitek: Andrew Klaus
 *
 * I2C Address: 0x59
\*********************************************************************************************/
...
void Sgp4xSendReadCmd(void)
{
  ...
  uint16_t error;
  uint16_t rhticks = (uint16_t)((InfinitekGlobal.humidity * 65535) / 100 + 0.5);
  uint16_t tempticks = (uint16_t)(((InfinitekGlobal.temperature_celsius + 45) * 65535) / 175);
