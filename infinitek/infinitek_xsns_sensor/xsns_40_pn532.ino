/*
  xsns_40_pn532.ino - Support for PN532 (HSU) NFC Tag Reader on Infinitek
...
void PN532_Init(void) {
  if (PinUsed(GPIO_PN532_RXD) && PinUsed(GPIO_PN532_TXD)) {
    PN532_Serial = new InfinitekSerial(Pin(GPIO_PN532_RXD), Pin(GPIO_PN532_TXD), 1);
