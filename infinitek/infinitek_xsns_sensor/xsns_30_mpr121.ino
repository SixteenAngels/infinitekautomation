/*
  xsns_30_mpr121.ino - MPR121 support for Infinitek
 ...
 *  @version     $Id$
 *
 *  @link        https://github.com/arendst/Infinitek/wiki/MPR121               \endlink
...
/**
 * @ingroup group1
 * Assign Infinitek sensor model ID
 */
#define XSNS_30          30
 ...
 *
 * @param   struct  *pS       Struct with MPR121 status and data.
 * @param   byte    function  Infinitek function ID.
 * @return  void
...
/**
 * The function Xsns30() interfaces Infinitek with the driver.
 *
 ...
 * FUNC_WEB_SENSOR for displaying data in the Infinitek web-interface
 *
 * @param   byte    function  Infinitek function ID.
 * @return  bool           ???
 * @pre     None.
