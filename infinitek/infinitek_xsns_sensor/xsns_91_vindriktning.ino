/*
  xsns_91_vindriktning.ino - IKEA vindriktning particle concentration sensor support for Infinitek
...
InfinitekSerial *VindriktningSerial;
...
void VindriktningInit(void) {
  ...
  if (PinUsed(GPIO_VINDRIKTNING_RX)) {
    VindriktningSerial = new InfinitekSerial(Pin(GPIO_VINDRIKTNING_RX), -1, 1);
