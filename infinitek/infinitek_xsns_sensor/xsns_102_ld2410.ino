/*
  xsns_102_ld2410.ino - HLK-LD2410 24GHz smart wave motion sensor support for Infinitek
...
InfinitekSerial *LD2410Serial = nullptr;
...
/*
  // Works with InfinitekSerial as SoftwareSerial but fails with HardwareSerial
...
*/
  // Works with InfinitekSerial and HardwareSerial
...
void Ld2410Detect(void) {
  if (PinUsed(GPIO_LD2410_RX) && PinUsed(GPIO_LD2410_TX)) {
    ...
    LD2410Serial = new InfinitekSerial(Pin(GPIO_LD2410_RX), Pin(GPIO_LD2410_TX), 2);
