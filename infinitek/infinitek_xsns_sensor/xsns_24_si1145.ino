/*
  xsns_24_si1145.ino - SI1145/46/47 UV Index / IR / Visible light sensor support for Infinitek
...
#ifdef USE_DOMOTICZ
      if (0 == InfinitekGlobal.tele_period) DomoticzSensor(DZ_ILLUMINANCE, si1145_visible);
#endif  // USE_DOMOTICZ
#ifdef USE_WEBSERVER
    } else {
