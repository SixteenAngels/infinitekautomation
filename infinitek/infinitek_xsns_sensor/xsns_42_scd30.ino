/*
  xsns_42_scd30.ino - SCD30 CO2 sensor support for Infinitek
...
bool Xsns42(uint32_t function) {
  ...
  // https://github.com/arendst/Infinitek/issues/15438 and datasheet (The boot-up time is < 2 s.)
/*
  if (FUNC_INIT == function) {
    Scd30Detect();
  }
*/
  if (!Scd30.init_once && (FUNC_EVERY_SECOND == function) && (InfinitekGlobal.uptime > 3)) {
