...
const be_const_member_t lv_gpio_constants[] = {
    ...
    { "InfinitekCLIENT_RST", (int32_t) GPIO_InfinitekCLIENT_RST },
    { "InfinitekCLIENT_RST_INV", (int32_t) GPIO_InfinitekCLIENT_RST_INV },
    { "InfinitekCLIENT_RXD", (int32_t) GPIO_InfinitekCLIENT_RXD },
    { "InfinitekCLIENT_TXD", (int32_t) GPIO_InfinitekCLIENT_TXD },
