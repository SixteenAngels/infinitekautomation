...
class FTP : Driver
    ...
    def init()
        ...
        self.data_ip = Infinitek.wifi()['ip']
        self.dir = PATH()
        self.readDir()
        self.data_ptr = 0
        ...
        if self.data_client.connected()
            ...
            if mode == "MLSD"
                ...
                if isdir
                    ...
                    date = Infinitek.strftime("%b %d %H:%M", date)
                end
    ...
    def handleConnection() # main loop for incoming commands
        ...
        #options
            ...
            if self.file_rename != nil
                Infinitek.cmd(f"UfsRename {self.file_rename},{self.dir.get_url()}{arg}")
