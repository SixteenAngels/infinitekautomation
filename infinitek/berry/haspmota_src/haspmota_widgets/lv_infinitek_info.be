# lv_Infinitek_info class

class lv_Infinitek_info : lv.label
  var msg
  var delay
  ...
  def update()
    var wifi_ip = "IP: " + Infinitek.wifi().find('ip', '') + "   " + Infinitek.eth().find('ip', '')
    var tas_mem = Infinitek.memory()
