...
- and displays a Infinitek styled web page
-
- Copy the following in `autoexec.be` in Infinitek file system
-----------------------------------------------------------------------#
...
class Web_page_demo : Driver
  ...
  def page_say_hello()
    ...
    webserver.content_send("Infinitek says hello!")   #- send any html -#
...
Infinitek.add_driver(web_page_demo_instance)
