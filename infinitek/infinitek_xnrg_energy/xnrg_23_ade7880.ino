/*
  xnrg_23_ade7880.ino - ADE7880 energy sensor support for Infinitek
 ...
 * I2C Address: 0x38
 *********************************************************************************************
 * - ATTENTION Before installing Infinitek retrieve the calibration data from the Shelly 3EM:
 ...
 * - Install Infinitek and use the above template.
...
//    Energy->kWhtoday_delta[phase] += Energy->active_power[phase] * 1000 / 36;
    ...
    // 273 * 402653184 / 16384000 = 6709 = 67,09W * 1000 / 36 = 1863 deca micro Wh (Infinitek needs deca micro Wh)
...
//        Energy->use_overtemp = true;                                        // Use global temperature for overtemp detection
        ...
        InfinitekGlobal.energy_driver = XNRG_23;
      }
    }
  }
}
