/*
  xnrg_24_bl0906.ino - BL0906 energy sensor support for Infinitek
 ...
 * See https://github.com/arendst/Infinitek/discussions/22167
 * 
...
InfinitekSerial *Bl0906Serial = nullptr;
...
void Bl0906EverySecond(void) {
  if (!(InfinitekGlobal.uptime % BL0906_UPDATE)) {  // Every BL0906_UPDATE seconds an update
    if (UINT8_MAX == Bl0906.current_channel) {
...
void Bl0906Init(void) {
  ...
  Bl0906Serial = new InfinitekSerial(Bl0906.rx_pin, Pin(GPIO_TXD), 1);
