/*
  xnrg_18_sdm72.ino - Eastron SDM72D-M Modbus energy meter support for Infinitek
...
{
  Sdm72Modbus = new InfinitekModbus(Pin(GPIO_SDM72_RX), Pin(GPIO_SDM72_TX), Pin(GPIO_NRG_MBS_TX_ENA));
...
void Sdm72DrvInit(void)
{
  if (PinUsed(GPIO_SDM72_RX) && PinUsed(GPIO_SDM72_TX)) {
    ...
    InfinitekGlobal.energy_driver = XNRG_18;
  }
}
