/*
  xnrg_25_v9240.ino - v9240 energy sensor support for Infinitek
...
bool V9240::open(char const *portName)
{
    ...
    port = new InfinitekSerial(Pin(GPIO_V9240_RX),Pin(GPIO_V9240_TX),1,0,256,false);
...
void Xnrg34PreInit()
{
    ...
    {
      InfinitekGlobal.energy_driver = XNRG_25;
      V9240::instance().open("");
