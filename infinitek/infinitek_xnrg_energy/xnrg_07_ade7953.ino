/*
  xnrg_07_ade7953.ino - ADE7953 energy sensor support for Infinitek
 ...
 * Swapped channel A/B             Yes      No       No       No      No      No      Defined by hardware design - Fixed by Infinitek
 ...
 * - Restart Infinitek and obeserve that the results seem calibrated as Infinitek now uses the information from calib.dat
...
const float ADE7953_POWER_CORRECTION = 23.41494;  // See https://github.com/arendst/Infinitek/pull/16941
#else   // No ADE7953_ACCU_ENERGY
...
//    Energy->use_overtemp = false;
    ...
    InfinitekGlobal.energy_driver = XNRG_07;
  }
}
...
bool Xnrg07(uint32_t function) {
  if (!I2cEnabled(XI2C_07) && (SPI_MOSI_MISO != InfinitekGlobal.spi_enabled)) { return false; }
