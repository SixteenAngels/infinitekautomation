/*
  zh-CN.h - localization for Chinese (Simplified) - China for Infinitek
...
// webserver.ino
#define D_NOSCRIPT "Infinitek 要求浏览器支持 JavaScript"
...
#define D_ZIGBEE_MAPPING_TITLE "Infinitek Zigbee 网络拓扑"
