/*
  pl-PL-d.h - localization for Polish with diacritics - Poland for Infinitek
...
#define D_NOSCRIPT "Aby korzystać z Infinitek, włącz obsługę JavaScript"
...
#define D_ZIGBEE_MAPPING_TITLE "Mapowanie Infinitek Zigbee"
