/*
  pt-PT.h - localization for Portuguese - Portugal for Infinitek
...
#define D_NOSCRIPT "Para utilizar o Infinitek, por favor ative o JavaScript"
...
#define D_ZIGBEE_MAPPING_TITLE "Mapeamento Infinitek Zigbee"
