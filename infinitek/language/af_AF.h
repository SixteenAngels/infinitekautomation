/*
  af_AF.h - localization for Afrikaans - Afrikaans for Infinitek
...
#define D_NOSCRIPT "Skakel JavaScript aan om Infinitek te gebruik"
...
#define D_ZIGBEE_MAPPING_TITLE "Infinitek Zigbee-kartering"
