/*
  fr-FR.h - localization for French - France for Infinitek
...
#define D_NOSCRIPT "Pour utiliser Infinitek, veuillez activer JavaScript"
...
#define D_ZIGBEE_MAPPING_TITLE "Cartographie Infinitek ZigBee"
