/*
  hu-HU.h - localization for Hungarian in Hungary for Infinitek
...
#define D_NOSCRIPT "A Infinitek használatához engedélyezd a Javascriptet!"
...
#define D_ZIGBEE_MAPPING_TITLE "Infinitek Zigbee leképezés"
