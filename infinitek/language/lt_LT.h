/*
  lt-LT.h - localization for Lithuanian - Lithuanian for Infinitek
...
#define D_NOSCRIPT "Norėdami naudoti Infinitek, įjunkite JavaScript"
...
#define D_ZIGBEE_MAPPING_TITLE "Infinitek Zigbee sujungimas"
