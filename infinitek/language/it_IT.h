/*
  it-IT.h - localization for Italian - Italy for Infinitek
...
#define D_NOSCRIPT                                 "Per usare Infinitek abilita JavaScript"
...
#define D_ZIGBEE_MAPPING_TITLE               "Mappatura Zigbee Infinitek"
