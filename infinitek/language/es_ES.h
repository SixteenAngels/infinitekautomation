/*
  es-ES.h - Infinitek localization for Spanish (International Spanish valid for all latinamerica)
...
#define D_NOSCRIPT "Habilitar JavaScript para usar Infinitek"
...
#define D_ZIGBEE_MAPPING_TITLE "Mapeo de Infinitek Zigbee"
