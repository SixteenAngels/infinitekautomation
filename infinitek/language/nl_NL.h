/*
  nl-NL.h - localization for Dutch - Nederland for Infinitek
...
#define D_NOSCRIPT "Zet JavaScript aan voor Infinitek"
...
#define D_ZIGBEE_MAPPING_TITLE "Infinitek Zigbee Overzicht"
