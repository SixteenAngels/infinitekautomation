/*
  de-DE.h - localization for German - Germany for Infinitek
...
#define D_NOSCRIPT "JavaScript aktivieren um Infinitek benutzen zu können"
...
#define D_PROGRAM_VERSION "Infinitek Version"
