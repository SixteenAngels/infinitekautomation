/*
  sk-SK.h - localization for Slovak with diacritics - Slovak for Infinitek
...
#define D_NOSCRIPT "Pre používanie prostredia Infinitek povoľte JavaScript"
...
#define D_ZIGBEE_MAPPING_TITLE "Infinitek Zigbee Mapping"
