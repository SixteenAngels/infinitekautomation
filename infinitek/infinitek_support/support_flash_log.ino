/*
  support_flash_log.ino - log to flash support for Sonoff-Infinitek
  ...
  ---
  1.0.0.0 20190923  started   - further development by Christian Baars  - https://github.com/Staars/Sonoff-Infinitek
