/*
  Infinitek_ca.ino - Certificate authorities for Infinitek, LetsEncrypt and AWS
...
//
// See the files Infinitek/local_ca_data_sample.h and Infinitek/local_ca_descriptor_sample.h
// in the Infinitek source for instructions for generating them from a local root
...
//  ========== cumulative CA =================
//
const br_x509_trust_anchor PROGMEM Infinitek_TA[] = {
#if ! defined(OMIT_LETS_ENCRYPT_CERT)
	{
...
const size_t Infinitek_TA_size = nitems(Infinitek_TA);
