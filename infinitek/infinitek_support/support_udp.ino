/*
  support_udp.ino - Udp support for Infinitek
...
#define UDP_Infinitek_DEBUG     true
...
{
  if (!udp_connected && !InfinitekGlobal.restart_flag) {
...
#else
        if (InfinitekGlobal.devices_present && (strstr_P(packet_buffer, PSTR("M-SEARCH")) != nullptr)) {
#endif
