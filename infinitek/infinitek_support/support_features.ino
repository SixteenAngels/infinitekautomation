/*
  support_features.ino - feature support for Infinitek
...
#endif
#ifdef USE_LIGHT
  0x00000002 |  // Infinitek.ino, xdrv_04_light.ino
#endif
#ifdef USE_I2C
  0x00000004 |  // Infinitek.ino
#endif
#ifdef USE_SPI
  0x00000008 |  // Infinitek.ino
#endif
#ifdef USE_DISCOVERY
  0x00000010 |  // Infinitek.ino
#endif
#ifdef USE_ARDUINO_OTA
  0x00000020 |  // Infinitek.ino
#endif
#ifdef USE_MQTT_TLS
...
//#endif
//#if (MQTT_LIBRARY_TYPE == MQTT_InfinitekMQTT)
...
// #endif
  ...
  0x00010000 |  // xdrv_31_Infinitek_client.ino
#endif
...
void ResponseAppendFeatures(void) {
  ...
  for (uint32_t i = 0; i < (sizeof(feature) / sizeof(uint32_t)); i++) {
    ResponseAppend_P(PSTR(",\"%08X\""), feature[i]);                            // Infinitek feature list
  }
